...
class BlobStorage:
    ...
    def __init__(self):
        self.__default_endpoints_protocol = ConfigManager.get(
            "blob_store", "default_endpoints_protocol"
        )
    ...
    def _get_connection_url(self):
        ...
        """
        return (
            f"DefaultEndpointsProtocol={self.__default_endpoints_protocol};AccountName={self.__account_name};"
    ...
    def get_client(self, container_name, blob_name):
        ...
        try:
            client = BlobClient.from_connection_string(
                conn_str=self._get_connection_url(),
